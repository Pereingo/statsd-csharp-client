...
namespace StatsdClient
{
    public interface IStatsd
    {
        ...
        void Send<TCommandType>(string name, double value, params string[] tags) where TCommandType : ICommandType;
        void Add<TCommandType>(string name, int value, params string[] tags) where TCommandType : ICommandType;
        void Add<TCommandType>(string name, double value, params string[] tags) where TCommandType : ICommandType;
        void Send<TCommandType>(string name, int value, double sampleRate, params string[] tags) where TCommandType : ICommandType;
        void Send<TCommandType>(string name, double value, double sampleRate, params string[] tags) where TCommandType : ICommandType;
        void Add<TCommandType>(string name, int value, double sampleRate, params string[] tags) where TCommandType : ICommandType;
        void Add<TCommandType>(string name, double value, double sampleRate, params string[] tags) where TCommandType : ICommandType;
